...
export default function ContactPage() {
	...
	return (
		<section
			className='swiper-slide bg-black flex flex-col justify-between overflow-hidden lg:flex-row lg:justify-center lg:gap-16 lg:relative'
			id='slide-6'
		>
			...
			<section className={ `flex flex-col justify-center transition-all duration-1000
							${ currentSlide < 6 ? '-translate-y-64 opacity-0' : 'translate-y-0 opacity-100' }
